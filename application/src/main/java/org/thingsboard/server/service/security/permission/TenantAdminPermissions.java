...
public class TenantAdminPermissions extends AbstractPermissions {
    ...
    private static final PermissionChecker tenantPermissionChecker = new PermissionChecker.GenericPermissionChecker(
            Operation.READ, Operation.READ_ATTRIBUTES, Operation.READ_TELEMETRY, Operation.DELETE) {
