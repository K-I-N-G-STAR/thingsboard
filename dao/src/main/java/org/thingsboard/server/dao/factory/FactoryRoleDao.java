...
public interface FactoryRoleDao {

    FactoryRole save(TenantId tenantId, FactoryRole role);

    FactoryRole findById(TenantId tenantId, FactoryRoleId roleId);

    FactoryRole findByTenantIdAndCode(TenantId tenantId, String roleCode);

    List<FactoryRole> findByTenantIdAndIds(TenantId tenantId, Collection<UUID> roleIds);

    PageData<FactoryRole> findRoles(TenantId tenantId, PageLink pageLink);

    void deleteById(TenantId tenantId, FactoryRoleId roleId);

    List<String> findRolePermissionCodes(TenantId tenantId, FactoryRoleId roleId);

    List<String> findPermissionCodesByRoleIds(TenantId tenantId, Collection<UUID> roleIds);
